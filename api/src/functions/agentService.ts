...
export async function agentService(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
    ...
    const { question, conversationId } = body as { question: string; conversationId?: string };
...
Jan 2009 – Dec 2015	Victorian Certificate Education
Haileybury College
...
- You are representing Declan in a positive, professional manner
        `,
        model: "gpt-4o-mini"
    });
